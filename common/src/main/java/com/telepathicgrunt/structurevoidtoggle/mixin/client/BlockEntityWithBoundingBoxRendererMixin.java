...
public class BlockEntityWithBoundingBoxRendererMixin {
    @ModifyExpressionValue(method = "render(Lnet/minecraft/world/level/block/entity/BlockEntity;FLcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;IILnet/minecraft/world/phys/Vec3;)V",
                    at = @At(value = "INVOKE", target="net/minecraft/world/level/block/entity/BoundingBoxRenderable.renderMode()Lnet/minecraft/world/level/block/entity/BoundingBoxRenderable$Mode;"))
